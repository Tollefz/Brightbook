    ...
    <main className="min-h-screen bg-slate-50 py-12">
      <div className="mx-auto max-w-screen-2xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 text-center">
          ...
          <h1 className="mb-4 text-4xl font-bold text-dark">Om BookBright</h1>
        ...
        <section className="mb-12 rounded-xl bg-white p-8 shadow-sm">
          ...
          <div className="space-y-4 text-gray-medium">
            <p>
              BookBright ble grunnlagt med et enkelt mål: å gjøre det enkelt å kjøpe premium leselys og produkter for nattlesing.
            </p>
            <p>
        ...
        <section className="mb-12 grid gap-6 md:grid-cols-2">
          ...
          <div className="rounded-xl bg-white p-6 shadow-sm">
            ...
            <p className="text-gray-medium">
              BookBright er et norsk selskap med hovedkontor i Oslo. Vi forstår norske forbrukere.
            </p>
          </div>
        </section>
        ...
        <section className="rounded-xl bg-brand-light p-8 text-center">
          ...
          <p className="mb-6 text-gray-medium">
            Kontakt oss gjerne hvis du har spørsmål om BookBright
          </p>
