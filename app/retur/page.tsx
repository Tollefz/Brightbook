      ...
      <div className="mx-auto max-w-screen-2xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <div className="flex gap-6">
              ...
              <div>
                ...
                <p className="text-gray-medium">
                  Send e-post til <a href="mailto:support@bookbright.no" className="text-brand hover:underline">support@bookbright.no</a> eller ring +47 41299063. Oppgi ordrenummer.
                </p>
              </div>
            </div>
        ...
        <section className="mt-12 rounded-xl bg-white p-8 shadow-sm text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a
              href="mailto:support@bookbright.no"
