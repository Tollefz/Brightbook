      ...
      <Body style={styles.body}>
        <Container style={styles.container}>
          ...
          <Section style={styles.infoBox}>
            ...
            <Text style={styles.infoText}>
              Din ordre blir behandlet manuelt av BookBright. Vi sender deg sporingsinformasjon så snart pakken er sendt.
            </Text>
            <Text style={styles.infoText}>
          ...
          <Text style={styles.text}>
            ...
            <a href="mailto:support@bookbright.no" style={styles.link}>
              support@bookbright.no
            </a>
            {' '}eller se{' '}
            <a href={`${process.env.NEXTAUTH_URL || 'https://www.bookbright.no'}/vilkar`} style={styles.link}>
              vilkår og betingelser
            </a>
            {' '}og{' '}
            <a href={`${process.env.NEXTAUTH_URL || 'https://www.bookbright.no'}/retur`} style={styles.link}>
              returrett
            </a>
            .
          </Text>
